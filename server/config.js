...
const common = {
    baseUrl: process.env.FABU_BASE_URL || "https://appdown.devproxy.yicheapp.vip", //baseUrl应用请求的url地址,比如https://fabu.love
    ...
    dbUser: process.env.FABU_DBUSER || "fabulove", //数据库用户 (没有开启mongodb用户认证的可以不填写)
    dbPass: process.env.FABU_DBPWD || "yryc2020", //数据库密码 (没有开启mongodb用户认证的可以不填写)
